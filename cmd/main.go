...
import (
	...
	"github.com/KGEmmanuel/KubeCortex/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9522d351.kubecortex.io",
	...
	if err := (&controller.PlanRequestReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "PlanRequest")
		os.Exit(1)
	}
